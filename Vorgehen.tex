...
Es wurde für alle drei Feature-Extraction Methoden keine Begrenzung der Anzahl Features vorgenommen und erst mit LSA beziehungsweise der direkten Scikit-Learn Implementierung "TruncatedSVD" die Feature-Reduktion vorgenommen. Alle drei Feature-Extraction Methoden wurden mit LSA auf 100 Features reduziert, trainiert und schlussendlich mit ihren Metriken verglichen.
