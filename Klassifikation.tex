...
\begin{itemize}
	...
	\item Evaluator - Auswertung der Klassifizierung von Daten (nur im Entwicklungsmodus)
\end{itemize}
...
Die nachfolgenden Methoden des Basis Preprocessing werden in jedem Fall vor der Klassifikation durchgeführt.
...
Die Experimente sind auf dem Trainings- und Validierungsdatensatzes des Gold Standards durchgeführt worden. 
Die schlussendlichen Resultate wurden anhand des Testdatensatzes durchgeführt.
...
Mittels der Funktion \glqq GridSearchCV\footnote{\url{https://scikit-learn.org/stable/modules/generated/sklearn.model_selection.GridSearchCV.html}abgerufen am: 07.05.2019}\grqq{} von Scikit-Learn wurde die Hyperparametersuche für die Optimierung des F1-Scores durchgeführt.\\
...
Auf der anderen Seite werden leider 16 Menüseiten als keine Menüseiten klassifiziert.
Dies erklärt den tiefen Recall und führt dazu, dass etwa 32\% weniger Menüseiten gefunden werden, als eigentlich vorhanden sind.\\
...
Jedoch wurde das Ziel mit verschiedenen Klassifizierern nur leicht verfehlt.
Aus den Ergebnissen ist zu entnehmen, dass für eine weitere Erarbeitung der Thematik die Ansätze mit Machine-Learning die grössten Erfolgschancen bieten.
Die regelbasierten Ansätze bieten auf kleinen Datenmengen zwar gute Ergebnisse, die Fehlerquote der regelbasierten Ansätze steigt jedoch stetig mit der Erhöhung der Datenmenge.
Somit sind die regelbasierten Ansätze zu unflexibel.\\
Es lässt sich vermuten, dass mit weiteren Optimierungen der Algorithmen sowie der Daten das Ziel erreichbar ist.
Gründe für das Verfehlen des Ziels und allfällige Massnahmen, um dieses trotzdem zu erreichen, sind in \cref{chap:fazit} zu finden.
\\\\
Obwohl das Ziel der Forschungsfrage nicht erreicht werden konnte, ist ersichtlich, dass der beste Klassifizierer aus der Machine-Learning Variante dennoch eine qualitative und quantitative Klassifizierung von Menüseiten erzielen kann.
Der F1-Score liegt zwar leicht unter der gesetzten Marke von 0.8, jedoch ist die Precision mit 0.92 weit darüber.
\\
...
Der beste Machine-Learning Klassifizierer bietet einen guten Kompromiss zwischen Precision und Recall und wird aufgrund dessen für die Suchmaschine verwendet.
