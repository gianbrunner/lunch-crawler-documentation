...
Die schlussendlichen Resultate wurden anhand des Testdatensatzes dessen durchgeführt.
...
Es lässt sich vermuten, dass mit weiteren Optimierungen an den Algorithmen sowie der Daten das Ziel sich erreichen lässt.
