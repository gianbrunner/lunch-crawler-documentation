...
\begin{figure}[H]
	...
	\source{Github\footnote{\url{http://rasbt.github.io/mlxtend/user_guide/general_concepts/gradient-optimization/} aufgerufen am: 05.08.2019}}
	\label{fig:sgd}
\end{figure}
...
\begin{figure}[H]
	...
	\source{towardsdatascience\footnote{\url{https://towardsdatascience.com/perceptron-the-artificial-neuron-4d8c70d5cc8d?} aufgerufen am: 05.08.2019}}
...
\begin{figure}[H]
	...
	\source{Researchgate\footnote{\url{https://www.researchgate.net/figure/Abbildung-410-Illustration-des-Nearest-Centroid-Verfahrens-mit-den-Gruppen-soft_fig4_267488030} aufgerufen am: 14.05.2019}}
	\label{fig:centroid}
\end{figure}
