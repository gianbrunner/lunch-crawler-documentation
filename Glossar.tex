...
\begin{table}[H]
	\begin{tabular}{>{\em}p{4cm}p{12cm}}
		...
		Machine-Learning & Ein Computer wird mit Hilfe von Daten trainiert, um eine Aufgabe zu verrichten. Das Trainieren erfolgt auf der Mustererkennung von diesen Daten. Mit der Erkennung von Muster, können später verallgemeinerte Aussagen gemacht werden. Beim \glqq normalen\grqq{} Programmieren definiert der Programmierer die Instruktionen, beim Machine-Learning jedoch erlernt der Computer die Instruktionen selber.\\
